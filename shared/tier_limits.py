...
GENERAL_CHAT_DAILY_TURNS: Dict[str, Optional[int]] = {
    TIER_FREE: 5,     # 무료도 자유 질문 허용 (일 5턴, 락인 미끼)
    TIER_PRO: 50,
    TIER_PREMIUM: None,
}
...
def get_general_chat_daily_limit(tier: str) -> Optional[int]:
    return GENERAL_CHAT_DAILY_TURNS.get(normalize_tier(tier), 5)
